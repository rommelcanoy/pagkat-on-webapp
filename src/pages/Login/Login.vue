...
<template>
  <section class="bg-gray-50 md:h-screen dark:bg-gray-900 flex flex-col">
    <general-nav />
    <div class="flex-1 flex flex-col items-center justify-center">
      ...
      <div
        ...
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <form class="space-y-4 md:space-y-6" action="javascript:void(0)" ref="form" @submit="this.auth.login($event)">
            <div>
            ...
            <button @click="this.$refs.form.submit()"
