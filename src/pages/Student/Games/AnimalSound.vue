...
<template>
  <!-- <div class="h-screen flex bg-gray-100 text-gray-900 flex-1">
    <div class="ml-64 flex-1 flex flex-col ">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
          ...
          <li aria-current="page">
            <div class="flex items-center">
              ...
              <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Animal Sound</span>
            </div>
          </li>
        </ol>
      </nav>
      ...
      <div class="absolute right-0 top-0 left-0 bottom-0">
        <div class="h-full">
          <h3 class="text-2xl text-gray-700">Animal Sound</h3>
  ...
  <div class="absolute right-0 top-0 left-0 bottom-0">
    ...
    <iframe src="../../../../games/AnimalSound/index.html" class="z-10" height="100%" width="100%"
