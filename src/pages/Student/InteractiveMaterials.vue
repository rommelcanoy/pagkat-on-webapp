      ...
      <div class="">
        <div class="container mx-auto px-4 sm:px-8 w-full max-w-screen-xl">
          ...
          <div class="py-8">
            ...
            <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto grid grid-cols-4 gap-4">
          ...
          <div class="py-8">
            ...
            <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto grid grid-cols-4 gap-4">
              ...
              <div
                ...
                <div class="p-5">
                  <a href="#">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Assessment 1</h5>
                  </a>
                  <p class="mb-3 font-normal text-gray-700 dark:text-gray-400"></p>
                  <router-link to="/student/assessment/1"
                               class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    View
                    <svg aria-hidden="true" class="w-4 h-4 ml-2 -mr-1" fill="currentColor" viewBox="0 0 20 20"
                         xmlns="http://www.w3.org/2000/svg">
